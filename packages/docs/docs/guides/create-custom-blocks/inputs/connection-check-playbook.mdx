...
<Image alt="a value block that accepts a single type" src="/images/connection-checks/values-single.jpg" width={300} />
...
<Image alt="a value block that accepts multiple types" src="/images/connection-checks/values-multiple.jpg" width={300} />
...
<Image alt="a value block that accepts any type" src="/images/connection-checks/values-any-type.jpg" width={200} />
...
<Image alt="a value block that returns its type and its supertype" src="/images/connection-checks/values-subtype.png" width={350} />
...
<Image alt="a value block that returns its parameterized type and its unparameterized type" src="/images/connection-checks/values-parameterized-type.png" width={300} />
...
<Image alt="statement blocks that have a forced order" src="/images/connection-checks/statements-ordered.png" width={350} />
...
<Image alt="statement blocks that allow lots of middle blocks" src="/images/connection-checks/statements-multiple-middle-blocks.png" width={350} />
...
<Image alt="statement blocks that allow no middle blocks" src="/images/connection-checks/statements-no-middle-blocks.png" width={350} />
...
<Image alt="statement blocks that can be followed by multiple of one type of block, or multiple of another, but not both" src="/images/connection-checks/statements-either-or.png" width={550} />
