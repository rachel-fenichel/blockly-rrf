...
- **Application-specific code:** The generated code performs a task specific
  to a particular application. For example, [Blockly Developer Tools](https://raspberrypifoundation.github.io/blockly-samples/examples/developer-tools/index.html)
...
<Image
  alt="The UI of a maze application with an editor, an output panel, and a Run button."
  src="/images/application-overview/games-maze.png"
  srcDark="/images/application-overview/games-maze-dark.png"
  className="blockly"
  width="75%"
/>
...
<Image
  alt="The UI of a graph application with an editor, an output panel for an equation constructed by the user, and an output panel for a graph of that equation."
  src="/images/application-overview/graph-sample.png"
  srcDark="/images/application-overview/graph-sample-dark.png"
  width="75%"
/>
...
- [Scratch](https://scratch.mit.edu/), an application for creating animations
  ...
  <Image
    alt="The Scratch user interface."
    src="/images/application-overview/mit-scratch.png"
    srcDark="/images/application-overview/mit-scratch-dark.png"
    width="85%"
  />
...
- [MakeCode Arcade](https://www.microsoft.com/en-us/makecode), an application
  ...
  <Image
    alt="The MakeCode Arcade user interface."
    src="/images/application-overview/makecode-arcade.png"
    srcDark="/images/application-overview/makecode-arcade-dark.png"
    width="85%"
  />
...
- [MIT App Inventor](https://appinventor.mit.edu/), an application for
  ...
  <Image
    alt="The GUI designer in the App Inventor user interface"
    src="/images/application-overview/mit-app-inventor-gui.png"
    srcDark="/images/application-overview/mit-app-inventor-gui-dark.png"
    width="85%"
  />
  <Image
    alt="The Blockly editor in the App Inventor user interface"
    src="/images/application-overview/mit-app-inventor-blockly.png"
    srcDark="/images/application-overview/mit-app-inventor-blockly-dark.png"
    width="85%"
  />
