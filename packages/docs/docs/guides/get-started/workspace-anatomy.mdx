...
<Image alt="A workspace with a category toolbox, scroll bars, trashcan, and zoom controls." src="/images/glossary/workspace.png" className="blockly" width="70%" />
...
<Image alt="A workspace with a flyout toolbox containing four blocks." src="/images/glossary/flyout-toolbox.png" className="blockly" />

#### Category toolbox

[Category toolboxes][category-toolbox] have multiple sets of blocks.

<Image alt="A workspace with a category toolbox with eight categories (Logic, Loops, Math, etc.). No blocks are visible because no categories have been opened." src="/images/glossary/category-toolbox.png" className="blockly" />
...
<Image alt="A block for rounding numbers connected to a shadow number block, and a print block connected to a shadow text block. The shadow blocks are greyed out to show that they are default blocks and that you can drag other blocks on top of them." src="/images/glossary/shadow-blocks.png" className="screenshotImg" />
...
<Image alt="Block built from a value input, an end-of-row input, and a statement input." src="/images/glossary/inputs.png" srcDark="/images/glossary/inputs-dark.png" />
